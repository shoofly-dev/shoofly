...
echo "     $SHOOFLY_BIN/shoofly-log       browse recent alerts"
echo ""
if [[ -n "$SHELL_RC" ]]; then
...
echo "   │                                                  │"
echo "   │  Shoofly Basic doesn't protect Cowork sessions  │"
echo "   │  automatically — Cowork runs inside a VM where  │"
echo "   │  the host daemon can't see tool calls.           │"
echo "   │                                                  │"
echo "   │  Install the Cowork plugin to get coverage:      │"
echo "   │  shoofly.dev/plugins/shoofly-cowork-basic.zip   │"
echo "   │                                                  │"
